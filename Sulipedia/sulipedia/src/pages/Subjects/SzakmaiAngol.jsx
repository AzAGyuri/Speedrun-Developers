...
export function SzakAngol({ children, jwt }) {
  ...
  const dummyDataForEntrie = [
    ...
    },
    {
      ...
      content: "Recent developments and applications of artificial intelligence",
      date: "2023.03.15",
      author: "Emberke 2",
      category: "TECHNICAL_ENGLISH",
    },
    {
      ...
      content: "Understanding encryption techniques and cryptographic protocols",
      date: "2023.04.04",
      author: "Emberke 1",
      category: "TECHNICAL_ENGLISH",
    },
  ...
  axios.get('/entry?subject=TECHNICAL_ENGLISH', {
  ...
  <StyledList>
    ...
    {entries
      ...
      <StyledContainer style={{ backgroundColor: "#ccc" }}>
        <Title variant="h3">Szakmai Angol bejegyzések</Title>
        {selectedAuthor === null ? (
