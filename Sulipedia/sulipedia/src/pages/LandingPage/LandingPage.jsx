  ...
  const staticEntries = useMemo(
    ...
    []
      ...
      const handleNewEntrySave = () => {
        if (newEntryTitle.trim().length > 0 && newEntryContent.trim().length > 0) {
          const requestData = {
            title: newEntryTitle,
          ...
          alert("A bejegyzés címe és tartalma legalább 1 karakter hosszú kell, hogy legyen!");
        }
      };
