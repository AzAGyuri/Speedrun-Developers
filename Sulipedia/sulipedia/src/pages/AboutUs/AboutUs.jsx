...
const rows = [
    createData(
        ...
        <>
            Now they are convinced that a human  being  is not <br /> just free on his own, but
            has to go  out and earn money,  so that he can buy freedom! <br /> And now they have
                ...
                <Table sx={{ minWidth: 600 }} aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell align="center">Egy kedvelt idézetünk</StyledTableCell>
                            <StyledTableCell align="center">Egy számunkra kedves kép</StyledTableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {rows.map((row) => (
